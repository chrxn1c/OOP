...
//void Application::setRouteObjectReport(const std::string& route, const BaseClass* setObject) const {
...
SIGNAL_TYPE Application::getSignal() {
	return (SIGNAL_TYPE)(&Application::signal);
}


HANDLER_TYPE Application::getHandler() {
	return (HANDLER_TYPE)(&Application::handler);
}
